...
export class NewMigration1671247571022 implements MigrationInterface {
    name = 'NewMigration1671247571022'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`auth\` (\`uid\` int NOT NULL AUTO_INCREMENT, \`username\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`email\` varchar(255) NULL, \`mobile\` int NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`roles\` text NOT NULL DEFAULT USER, UNIQUE INDEX \`IDX_366ebf23d8f3781bb7bb37abbd\` (\`username\`), PRIMARY KEY (\`uid\`)) ENGINE=InnoDB`);
